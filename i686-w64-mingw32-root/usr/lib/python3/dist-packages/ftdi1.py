...
_ftdi1.EXTERNAL_OSCILLATOR_swigconstant(_ftdi1)
EXTERNAL_OSCILLATOR = _ftdi1.EXTERNAL_OSCILLATOR

_ftdi1.USER_DATA_ADDR_swigconstant(_ftdi1)
...
_ftdi1.CBUSH_DRIVE1_swigconstant(_ftdi1)
...
_ftdi1.CBUSX_TRISTATE_swigconstant(_ftdi1)
CBUSX_TRISTATE = _ftdi1.CBUSX_TRISTATE

_ftdi1.CBUSX_TXLED_swigconstant(_ftdi1)
CBUSX_TXLED = _ftdi1.CBUSX_TXLED

_ftdi1.CBUSX_RXLED_swigconstant(_ftdi1)
CBUSX_RXLED = _ftdi1.CBUSX_RXLED

_ftdi1.CBUSX_TXRXLED_swigconstant(_ftdi1)
CBUSX_TXRXLED = _ftdi1.CBUSX_TXRXLED

_ftdi1.CBUSX_PWREN_swigconstant(_ftdi1)
CBUSX_PWREN = _ftdi1.CBUSX_PWREN

_ftdi1.CBUSX_SLEEP_swigconstant(_ftdi1)
CBUSX_SLEEP = _ftdi1.CBUSX_SLEEP

_ftdi1.CBUSX_DRIVE_0_swigconstant(_ftdi1)
CBUSX_DRIVE_0 = _ftdi1.CBUSX_DRIVE_0

_ftdi1.CBUSX_DRIVE1_swigconstant(_ftdi1)
CBUSX_DRIVE1 = _ftdi1.CBUSX_DRIVE1

_ftdi1.CBUSX_IOMODE_swigconstant(_ftdi1)
CBUSX_IOMODE = _ftdi1.CBUSX_IOMODE

_ftdi1.CBUSX_TXDEN_swigconstant(_ftdi1)
CBUSX_TXDEN = _ftdi1.CBUSX_TXDEN

_ftdi1.CBUSX_CLK24_swigconstant(_ftdi1)
CBUSX_CLK24 = _ftdi1.CBUSX_CLK24

_ftdi1.CBUSX_CLK12_swigconstant(_ftdi1)
CBUSX_CLK12 = _ftdi1.CBUSX_CLK12

_ftdi1.CBUSX_CLK6_swigconstant(_ftdi1)
CBUSX_CLK6 = _ftdi1.CBUSX_CLK6

_ftdi1.CBUSX_BAT_DETECT_swigconstant(_ftdi1)
CBUSX_BAT_DETECT = _ftdi1.CBUSX_BAT_DETECT

_ftdi1.CBUSX_BAT_DETECT_NEG_swigconstant(_ftdi1)
CBUSX_BAT_DETECT_NEG = _ftdi1.CBUSX_BAT_DETECT_NEG

_ftdi1.CBUSX_I2C_TXE_swigconstant(_ftdi1)
CBUSX_I2C_TXE = _ftdi1.CBUSX_I2C_TXE

_ftdi1.CBUSX_I2C_RXF_swigconstant(_ftdi1)
CBUSX_I2C_RXF = _ftdi1.CBUSX_I2C_RXF

_ftdi1.CBUSX_VBUS_SENSE_swigconstant(_ftdi1)
CBUSX_VBUS_SENSE = _ftdi1.CBUSX_VBUS_SENSE

_ftdi1.CBUSX_BB_WR_swigconstant(_ftdi1)
CBUSX_BB_WR = _ftdi1.CBUSX_BB_WR

_ftdi1.CBUSX_BB_RD_swigconstant(_ftdi1)
CBUSX_BB_RD = _ftdi1.CBUSX_BB_RD

_ftdi1.CBUSX_TIME_STAMP_swigconstant(_ftdi1)
CBUSX_TIME_STAMP = _ftdi1.CBUSX_TIME_STAMP

_ftdi1.CBUSX_AWAKE_swigconstant(_ftdi1)
